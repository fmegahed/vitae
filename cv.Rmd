...
params:
  ...
  graduate_student_names: !r c('Lamooki,' , 'Hajifar,', 'Zhao, L.', 'Dolatsara,', 'Mehdizadeh,', 'Yazdi,', 'Cai,', 'Hu,', 'Lu, L.', 'Baghdadi,', 'Mohabbati-Kalejahi,', 'Maman,', 'Weng, B.', 'Tsai, YT.', 'Negahban,', 'Ahmed,', 'Dag,', 'Alhwiti,', 'Ansari,')
...
`r fa('bookmark', fill = 'miaimred')` **Externally Funded Research:** ~ \$`r scales::label_number_si(accuracy=0.01)(sum(external_funding$total_funding))` with my share ~ \$ `r scales::label_number_si(accuracy=10)(sum(external_funding$funding_share))`. \ul{Sponsors include:} `r paste(paste(noquote(sponsors_chr[1:5]),collapse=', '), noquote(sponsors_chr[6]),sep=', and ')`.
...
\faIdBadge \textit{Enders Associate Professor} \hfill \faCalendarCheck[regular] July 2022--current  
...
\item \textbf{Service:} 
  \begin{itemize}[nosep]
	    ...
	    \item MU Carbon Offsets Subcommittee: Member \hfill  \faCalendarCheck[regular] 2020--2023
		  ...
		  \begin{itemize}[nosep]
		     \item Chair \hfill  \faCalendarCheck[regular] 2019--2023
